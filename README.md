...
Este microservicio permite convertir cantidades de una moneda a otra utilizando códigos ISO 4217. Está construido con NestJS siguiendo una arquitectura hexagonal.

## Características

- Conversión de monedas utilizando una API externa
...
- **Dominio**: Contiene las entidades, interfaces y reglas de negocio
- **Aplicación**: Contiene los casos de uso y orquesta el flujo de datos
- **Infraestructura**: Contiene los adaptadores para comunicarse con sistemas externos
